...
module.exports = class Prompter {
  constructor() {
    ...
    const promptModules = ['babel', 'linter', 'typescript', 'doc'].map(file => require(`./promptModules/${file}`))
    promptModules.forEach(module => module(this))
  ...
  resolveFinalPrompts() {
    ...
    debug('jslib-cli:prompts')(prompts)
    return prompts
  }
}